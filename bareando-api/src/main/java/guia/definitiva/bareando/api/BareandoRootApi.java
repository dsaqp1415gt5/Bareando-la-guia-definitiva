...
public class BareandoRootApi {
	@InjectLinks({
            ...
            @InjectLink(value = "usuarios", style = Style.ABSOLUTE, rel = "registrar", title = "Todos los Bares", type = MediaType.BAREANDO_BAR_COLLECTION),
            @InjectLink(value = "usuarios/login", style = Style.ABSOLUTE, rel = "login", title = "Todos los Bares", type = MediaType.BAREANDO_BAR_COLLECTION),
