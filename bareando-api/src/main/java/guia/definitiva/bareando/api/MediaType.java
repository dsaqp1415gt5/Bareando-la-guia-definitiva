...
public interface MediaType {
	...
	public final static String BEETER_API_ERROR = "application/vnd.bareando.api.error+json";
	public final static String CHAT_MSJ = "application/vnd.bareando.api.chat.msj+json";
}
